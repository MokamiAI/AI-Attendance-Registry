...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'mokami.moyahabo@gmail.com' ")
...
window.configure(background='#27408B')
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="yellow",bg="#292421" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="yellow",bg="#292421" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Student ID",width=20  ,height=1  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)
